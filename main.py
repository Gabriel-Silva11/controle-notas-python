...
# ETAPA 5: SISTEMA DE GESTÃO ACADÊMICA CONSOLIDADO (DISCIPLINAS E ALUNOS)
    ...
    for materia in DISCIPLINAS_PADRAO:
      ...
      while True:
        ...
        try:
          ...
          print("  Erro: As notas devem estar obrigatoriamente entre 0 e 10.")
      ...
      while True:
        ...
        try:
          ...
          print("  Erro: A presença deve estar entre 0 e 100%.")

        except ValueError:

          print("  Entrada inválida! Digite um número inteiro para a presença.")
...
def gerar_relatorio_final(estudantes):
  ...
  for est in estudantes:
    ...
    for m in est["materias"]:
      ...
      # Define a situação por disciplina
